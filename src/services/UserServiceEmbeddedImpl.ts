...
import {UserFilePersistance} from "./UserFilePersistanceService.js";
import * as fs from "node:fs";
import {logger} from "../events/logger.js";

export class UserServiceEmbeddedImpl implements UserService,UserFilePersistance{
    ...
    restoreDataFromFile(): string {
        ...
        this.rs.on('end', () => {
            if(result){
                ...
                logger.log("Data restored from file");
                logger.save("Data restored from file");
                this.rs.destroy();
            }
            else {
            }
